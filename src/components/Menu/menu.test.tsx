...
describe('test Menu and MenuItem based on default props', () => {
  ...
  it('should render vertical mode when mode is set to vertical', () => {
    cleanup();
    wrapper = render(NiceMenu(tesVerProps));
    menuElement = wrapper.getByTestId('test-menu');
