...
export var Input = function (props) {
    ...
    var cnames = classnames('fire-input-wrapper', (_a = {},
    ...
    React.createElement("div", { className: cnames, style: style },
        prepend && React.createElement("div", { className: 'fire-input-group-prepend' }, prepend),
        icon && (React.createElement("div", { className: 'icon-wrapper' },
            React.createElement(Icon, { icon: icon, title: "title-" + icon }))),
        React.createElement("input", __assign({ className: 'fire-input-inner', disabled: disabled }, restProps)),
        append && React.createElement("div", { className: 'fire-input-group-append' }, append)));
};
