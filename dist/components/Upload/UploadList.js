...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: 'fire-upload-list' }, fileList.map(function (item) { return (React.createElement("li", { className: 'fire-upload-list-item', key: item.uid },
